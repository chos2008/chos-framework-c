/**
 * Register server for game server
 *
 * Register server provides account creating, logining, session data etc.
 * If the game is a rpg type game, the register server also initializes 
 * role for account in game.
 * 
 * Register server process below requests:
 * reg
 * login
 * 
 * @author a.da
